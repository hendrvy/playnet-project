...
async function handleLogin(event) {
    ...
    try {
        const response = await fetch('playnet-project.railway.internal/api/users/login', {
            method: 'POST',
...
async function handleSignup(event) {
    ...
    try {
        const response = await fetch('playnet-project.railway.internal/api/users/register', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function fetchActiveSessions() {
    ...
    try {
        const response = await fetch('playnet-project.railway.internal/api/admin/active-sessions', {
...
async function checkLoginStatus() {
    ...
    try {
        const response = await fetch('playnet-project.railway.internal/api/users/profile', {
            headers: { 'Authorization': `Bearer ${token}` }
        });
        if (!response.ok) {
...
async function handleForceUnbook(event) {
    ...
    try {
        const response = await fetch('playnet-project.railway.internal/api/admin/force-unbook', {
            method: 'POST',
...
async function handleAdjustTime(event) {
    ...
    try {
        const response = await fetch('playnet-project.railway.internal/api/admin/adjust-time', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json', 'Authorization': `Bearer ${token}` },
...
async function fetchAuditLog() {
    ...
    try {
        const response = await fetch('playnet-project.railway.internal/api/admin/audit-log', {
            headers: { 'Authorization': `Bearer ${token}` }
        });
...
async function fetchAdminMenu() {
    ...
    try {
        const response = await fetch('playnet-project.railway.internal/api/admin/menu', {
            headers: { 'Authorization': `Bearer ${token}` }
        });
...
async function handleMenuFormSubmit(event) {
    ...
    const url = isEditing ? `playnet-project.railway.internal/api/admin/menu/${itemId}` : 'playnet-project.railway.internal/api/admin/menu';
...
async function deleteMenuItem(id, name) {
    ...
    const token = localStorage.getItem('playnetToken');
    try {
        const response = await fetch(`playnet-project.railway.internal/api/admin/menu/${id}`, {
            method: 'DELETE',
            headers: { 'Authorization': `Bearer ${token}` }
        });
        const result = await response.json();
...
async function initializePCGrid() {
    ...
    try {
        const response = await fetch('playnet-project.railway.internal/api/pcs');
...
async function populateGameGrid(filter = 'all') {
    ...
    try {
        const response = await fetch('playnet-project.railway.internal/api/games');
...
async function populateFoodMenus(gridId, type) {
    ...
    if (globalFoodMenu.length === 0) {
        try {
            const response = await fetch('playnet-project.railway.internal/api/food/menu');
...
async function handlePayment() {
    ...
    try {
        const response = await fetch('playnet-project.railway.internal/api/booking', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json', 'Authorization': `Bearer ${token}` },
...
async function handleFoodOrder() {
    ...
    try {
        const response = await fetch('playnet-project.railway.internal/api/food/order', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json', 'Authorization': `Bearer ${token}` },
...
async function fetchTransactionHistory() {
    ...
    try {
        const response = await fetch('playnet-project.railway.internal/api/booking/history', {
            headers: { 'Authorization': `Bearer ${token}` }
        });
